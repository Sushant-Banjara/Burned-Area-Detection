...
var Train_img = ee.Image("users/banjarasushant/Train"),
    Fire = ee.FeatureCollection("users/banjarasushant/Fire"),
    No_Fire = ee.FeatureCollection("users/banjarasushant/No_Fire"),
    LC = ee.Image("users/banjarasushant/Landcover_Nepal");
/***** End of imports. If edited, may not auto-convert in the playground. *****/
//***This is the first part of the script that employs Machine Learning algorithm to retrospectively identify burned areas in the Himalaya Region***//
